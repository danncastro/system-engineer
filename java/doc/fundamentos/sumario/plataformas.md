---
description: >-
  Com a linguagem Java conseguimos desenvolver softwares para várias finalidades
  de negócio. Seja uma aplicação desktop, uma distribuição web, eletrônicos e
  dispositivos móveis.
---
...
<figure><img src="../../.gitbook/assets/image (11) (1) (1).png" alt=""><figcaption><p>Wikipedia - Camada responsável por interpretar os bytecodes para cada sistema operacional</p></figcaption></figure>
